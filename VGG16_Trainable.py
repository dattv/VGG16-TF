...
class Vgg16:
    ...
    def build(self, rgb, train_mode=False):
        ...
        self.poo1 = self.max_pool(self.conv1_2, "pool1")

        self.conv2_1 = self.conv_layer(self.poo1, 64, 128, "conv2_1")
        self.conv2_2 = self.conv_layer(self.conv2_1, 128, 128, "conv2_2")
        self.poo2 = self.max_pool(self.conv2_2, "pool2")

        self.conv3_1 = self.conv_layer(self.poo2, 128, 256, "conv3_1")
        self.conv3_2 = self.conv_layer(self.conv3_1, 256, 256, "conv3_2")
        self.conv3_3 = self.conv_layer(self.conv3_2, 256, 256, "conv3_3")
        self.conv3_4 = self.conv_layer(self.conv3_3, 256, 256, "conv3_4")
        self.poo3 = self.max_pool(self.conv3_4, "poo3")

        self.conv4_1 = self.conv_layer(self.poo3, 256, 512, "conv4_1")
        self.conv4_2 = self.conv_layer(self.conv4_1, 512, 512, "conv4_2")
        self.conv4_3 = self.conv_layer(self.conv4_2, 512, 512, "conv4_3")
        self.conv4_4 = self.conv_layer(self.conv4_3, 512, 512, "conv4_4")
        self.poo4 = self.max_pool(self.conv4_4, "pool4")

        self.conv5_1 = self.conv_layer(self.poo4, 512, 512, "conv5_1")
        self.conv5_2 = self.conv_layer(self.conv5_1, 512, 512, "conv5_2")
        self.conv5_3 = self.conv_layer(self.conv5_2, 512, 512, "conv5_2")
        self.conv5_4 = self.conv_layer(self.conv5_3, 512, 512, "conv5_3")
        self.poo5 = self.max_pool(self.conv5_4, "pool5")

        self.fc6 = self.fc_layer(self.poo5, 25088, 4096, "fc6")
